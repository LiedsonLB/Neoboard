...
const RegiaoPage = () => {
  return (
    <div id='regionpage-container'>
    <header id='regionpage-header'>
        <h1>Produto</h1>
    </header>

    <main id='regionpage-main'>
        <section id='regionpage-left'>
            <img src="" alt="" />
        ...
        <section id='regionpage-right'>
            <div id='regionpage-chart'>
